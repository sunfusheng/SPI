...
public class ProvideProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnvironment) {
        ...
        for (Element element : elements) {
            ...
            printNote("### packageSimpleName: " + packageName);
            printNote("### className: " + className);
            printNote("### annotationValue: " + annotationValue);

            try {

                String fileName = "SPI$$Providers$$" + packageName;
                fileName = fileName.replaceAll("[^0-9a-zA-Z_$]+", "_");
                JavaFile.builder("com.sunfusheng.spi.providers",
                        TypeSpec.classBuilder(fileName)
                                .addJavadoc("Do not edit this file! It was generated by sunfusheng.")
                                .addModifiers(PUBLIC)
                                .build()
                ).build().writeTo(mFiler);
                createdFileMap.put(fileName, annotationValue);
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
